...
STRINGS: Dict[str, Dict[str, str]] = {
    'ko': {
        ...
        'btn_settings': '⚙️ 옵션',
        'btn_convert_image': '🚀 WebP 변환',
        'btn_convert_video': '🚀 WebM 변환',
        ...
        'confirm_video_msg': '{count}개 동영상을 WebM으로 변환하시겠습니까?\n(FPS: {fps}, 최대 {duration}초)',
        'resize_applied': '\n(리사이징 적용됨)',
        'warning': '경고',
        ...
        'confirm_convert': '변환 확인',
        'confirm_image_msg': '{count}개 이미지를 품질 {quality}으로 WebP 변환하시겠습니까?',
        'confirm_video_msg_simple': '{count}개 동영상을 WebM으로 변환하시겠습니까?\n(FPS: {fps})',
        'msg_resize_applied': '\n(리사이징 적용됨)',
        # ... existing ...
        'starting': '시작 중...',
        ...
        'group_animated_webp': 'WebM (VP9) 옵션',
        ...
        'label_crf_hint': '(낮을수록 고품질)',
        'method_fast': ' (빠름)',
        'method_default': ' (기본)',
        'method_best': ' (최대 압축)',
        'label_preset': '프리셋:',
        'preset_custom': '사용자 지정',
        'preset_high_quality': '고품질 (24fps, CRF 20)',
        'preset_balanced': '균형 (15fps, CRF 30)',
        'preset_small_size': '최소 용량 (10fps, CRF 45)',
        'btn_ok': '확인',
    ...
    'en': {
        ...
        'btn_convert_image': '🚀 Convert to WebP',
        'btn_convert_video': '🚀 Convert to WebM',
        ...
        'confirm_video_msg': 'Convert {count} videos to WebM?\n(FPS: {fps}, max {duration}s)',
        'resize_applied': '\n(Resizing applied)',
        'warning': 'Warning',
        ...
        'confirm_convert': 'Confirm Conversion',
        'confirm_image_msg': 'Convert {count} images to WebP with quality {quality}?',
        'confirm_video_msg_simple': 'Convert {count} videos to WebM?\n(FPS: {fps})',
        'msg_resize_applied': '\n(Resizing applied)',
        # ... existing ...
        'starting': 'Starting...',
        ...
        'group_animated_webp': 'WebM (VP9) Options',
        ...
        'label_crf_hint': '(Lower = better quality)',
        'method_fast': ' (Fast)',
        'method_default': ' (Default)',
        'method_best': ' (Best Compression)',
        'label_preset': 'Preset:',
        'preset_custom': 'Custom',
        'preset_high_quality': 'High Quality (24fps, CRF 20)',
        'preset_balanced': 'Balanced (15fps, CRF 30)',
        'preset_small_size': 'Small Size (10fps, CRF 45)',
        'btn_ok': 'OK',
